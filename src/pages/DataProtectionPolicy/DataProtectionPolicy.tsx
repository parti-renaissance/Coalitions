...
const DataProtectionPolicy: FunctionComponent = () => (
  ...
  >
    ...
    <p>
      ...
      Cause&#8239;&raquo; sont trait&eacute;es par La R&eacute;publique En Marche (ci-apr&egrave;s
      &laquo; LaREM &raquo;). Les termes ci-dessous list&eacute;s ont la d&eacute;finition suivante
      :
    </p>
    <ul>
      <li>
        ...
        en se connectant via son Compte Personnel d&rsquo;adh&eacute;rent. L&rsquo;Adh&eacute;rent
        qui se connecte sur la Plateforme est consid&eacute;r&eacute; dans le cadre des
        pr&eacute;sentes comme un Utilisateur, soumis aux conditions g&eacute;n&eacute;rales
      ...
      <li>
        ...
        l&rsquo;enregistrement, l&rsquo;organisation, la structuration, la conservation,
        l&rsquo;adaptation ou la modification, l&rsquo;extraction, la consultation,
        l&rsquo;utilisation, la communication par transmission, la diffusion ou toute autre forme de
    ...
    <p>
      ...
      s&rsquo;applique uniquement pour les finalit&eacute;s ci-dessous. Pour d&rsquo;autres
      finalit&eacute;s, les donn&eacute;es personnelles seront trait&eacute;es par la Politique de
      protection des donn&eacute;es &agrave; caract&egrave;re personnel applicables aux
      adh&eacute;rents &agrave; LaREM, aux abonn&eacute;s &agrave; ses newsletters et aux
      utilisateurs ou visiteurs de son site internet accessible &agrave; l&rsquo;adresse
    ...
    <p>
      ...
      notamment pour les finalit&eacute;s et sur les fondements l&eacute;gaux suivants :
    </p>
    <ul>
      <li>
      ...
      <li>
        ...
        l&eacute;gale de tels traitements est le consentement et l&rsquo;article 9.2.d du RGPD
        permettant le traitement des donn&eacute;es susceptibles de r&eacute;v&eacute;ler
      ...
      <li>
        ...
        Causes, dans le cadre des activit&eacute;s li&eacute;es &agrave; la Plateforme et quels que
        soient les moyens de communication utilis&eacute;s (t&eacute;l&eacute;phone, email,
      ...
      <li>
        ...
        soient les moyens de communication utilis&eacute;s (t&eacute;l&eacute;phone, e-mail,
        courrier, SMS, MMS)&#8239;: la base l&eacute;gale de tels traitements est le consentement de
      ...
      <li>
        ...
        constitu&eacute; par la n&eacute;cessit&eacute; de prot&eacute;ger les personnes
      ...
      <li>
        ...
        cadre de la gestion et l&rsquo;animation des Causes et Coalitions sur la Plateforme&#8239;:
    ...
    <p>
      ...
      l&rsquo;acceptation des Conditions G&eacute;n&eacute;rales d&rsquo;Utilisation, la Charte des
      causes, la Charte de Bonnes Pratiques et la Politique de protection des donn&eacute;es. A
    ...
    <p>
      ...
      r&eacute;v&eacute;ler vos opinions politiques en vertu de l&rsquo;article 9.2.d du RGPD
    ...
    <p>
      ...
      n&eacute;cessaire &agrave; la r&eacute;alisation des finalit&eacute;s du traitement, &agrave;
      moins qu&rsquo;en tant qu&rsquo;Utilisateur, Visiteur, Contact r&eacute;gulier ou occasionnel,
      vous n&rsquo;ayez autoris&eacute; LaREM &agrave; conserver vos donn&eacute;es pour une
      utilisation ult&eacute;rieure. La dur&eacute;e de conservation des donn&eacute;es par LaREM
      varie en fonction des finalit&eacute;s des traitements mis en &#339;uvre.
    </p>
    <ul>
      <li>
        Pour la gestion des inscriptions &agrave; la Plateforme, la gestion des Contacts
        r&eacute;guliers/occasionnels et les op&eacute;rations de communication politique : les
        donn&eacute;es vous concernant peuvent &ecirc;tre conserv&eacute;es jusqu&rsquo;&agrave; 1
      ...
      <li>
        ...
        la publication et l&rsquo;animation des Causes et des Coalitions, le recensement des
        soutiens &agrave; des Causes : la dur&eacute;e de conservation des donn&eacute;es est la
      ...
      <li>
        ...
        Causes et Coalitions&#8239;: sauf accord contraire du Contact r&eacute;gulier ou
      ...
      <li>
        ...
        donn&eacute;es sera fix&eacute;e en fonction de la nature du projet objet de la
    ...
    <ul>
      ...
      <li>
        ...
        &agrave; traiter des Donn&eacute;es &agrave; caract&egrave;re personnel dans le cadre de
      ...
      <li>
        ...
        qui sont &eacute;galement soumis &agrave; des obligations de confidentialit&eacute; et de
    ...
    <p>
      ...
      Donn&eacute;es &agrave; caract&egrave;re personnel. Les donn&eacute;es des Utilisateurs, des
      Visiteurs, des Contacts r&eacute;guliers ou occasionnels pourront &ecirc;tre
      transf&eacute;r&eacute;es dans des pays pr&eacute;sentant une protection ad&eacute;quate au
    ...
    <p>
      ...
      limitation des traitements, est soumis &agrave; conditions et peut &ecirc;tre refus&eacute;
      par LaREM si les demandes d&rsquo;exercice de ces droits ne correspondent pas aux situations
    ...
    <p>
      ...
      d&eacute;lai peut &ecirc;tre rallong&eacute; de deux (2) mois pour atteindre un maximal de
      trois (3) mois en cas de demande complexe ou d&rsquo;un nombre important de demandes. Enfin,
      si LaREM ne satisfait pas &agrave; vos demandes, vous disposez du droit d&rsquo;introduire une
